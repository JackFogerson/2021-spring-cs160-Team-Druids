...
<body>
	...
	<form:form action="${pageContext.request.contextPath}/filterRestaurantSearch" modelAttribute="searchFilter">
 		Filter By Location:
 		<form:input type="search" name="location" placeholder="City or State..." size="50" path="location"/>
 		<br/>
 		<br/>
